...
if (process.argv.length < 4) {
    console.error("Recipient-list merkle tree calculator v1.0.0");
    console.error("    node recipient-tree.js root <addresses-file>");
    console.error("    node recipient-tree.js proof <addresses-file> <address-to-prove>");
    process.exit(1);
}
